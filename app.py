...
def process_request():
    ...
    # Process the request using your existing functions
    filter_data, message = search_products_pplx.text_to_text_conversation(session_id, user_question)
    product_link = search_products_pplx.create_url(filter_data, message)
